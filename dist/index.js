import { computed as e, ref as t, unref as n } from "vue";
...
function c(e = [], t) {
	...
	return e.find((e) => [
		...
		e.iso2,
		e.iso3
	].filter(Boolean).some((e) => s(e) === n));
}
function l(e = [], t) {
	var n;
	let r = c(e, t), i = r == null || (n = r.countryCodes) == null ? void 0 : n[0];
	return i ? `+${i}` : null;
}
function u(e = [], t) {
	var n, r, i, a, o, s;
	let l = c(e, t), u = m((n = (r = (i = (a = (o = l == null ? void 0 : l.phone_lengths) == null ? l == null ? void 0 : l.phoneLengths : o) == null ? l == null ? void 0 : l.phone_length : a) == null ? l == null ? void 0 : l.phoneLength : i) == null ? l == null ? void 0 : l.phone_max_length : r) == null ? l == null ? void 0 : l.phoneMaxLength : n);
	if (u.length > 0) return u;
	let d = h(l);
	return (s = d == null ? void 0 : d.lengths) == null ? [] : s;
}
function d(e = [], t) {
	let n = u(e, t), r = l(e, t);
...
function f(e = [], t, n) {
	var r;
	let i = l(e, t), a = (r = i == null ? void 0 : i.replace(/\D/g, "")) == null ? "" : r, o = n.replace(/\D/g, ""), s = a && o.startsWith(a) ? o.slice(a.length) : o, c = d(e, t);
	return c ? s.slice(0, c) : s;
}
function p(e = [], t) {
	var n, r;
	let i = l(e, t), a = c(e, t), o = h(a), s = _(a), u = Math.max(...(n = o == null ? void 0 : o.lengths) == null ? [10] : n);
	return i ? (s === "US" || s === "CA") && u === 10 ? `${i} (###) ###-####` : s === "IN" && u === 10 ? `${i} ##### #####` : `${i} ${g((r = o == null ? void 0 : o.groups) == null ? [u] : r)}` : "#".repeat(u);
}
function m(e) {
...
function h(e) {
	var t;
	let n = _(e);
	return n ? (t = o[n]) == null ? null : t : null;
}
function g(e) {
...
function v(r = a) {
	var i, o, s;
	let d = (i = n(r)) == null ? {} : i, m = e(() => {
		var e, t, i;
		return (e = (t = (i = n(r)) == null ? void 0 : i.countries) == null ? a.countries : t) == null ? [] : e;
	}), h = t((o = d.countryCode) == null ? "IN" : o), g = t(f(m.value, h.value, (s = d.phone) == null ? "" : s)), _ = e({
		get: () => c(m.value, h.value),
		set: (e) => {
			T(e == null ? "" : e);
		}
	}), v = e(() => u(m.value, h.value)), x = e(() => l(m.value, h.value)), S = e(() => p(m.value, h.value)), C = e(() => g.value.length > 0 && v.value.includes(g.value.length)), w = (e) => {
		let t = b(e), n = f(m.value, h.value, y(e)), r = n.length > 0 && v.value.includes(n.length);
		return g.value = n, t && (t.value = n), r;
	}, T = (e) => {
		h.value = y(e), w(g.value);
	};
	return {
		countryOptions: m,
		selectedCountry: _,
...
function y(e) {
	...
	return String((t = (n = b(e)) == null ? void 0 : n.value) == null ? "" : t);
}
function b(e) {
	if (typeof e == "string" || x(e)) return null;
	let t = e.target;
...
//#endregion
export { r as countries, i as dialCodes, a as phoneNumberData, v as usePhoneNumber };
